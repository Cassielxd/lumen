...
CREATE DATABASE  `lumen` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
INSERT INTO `sys_dict_item` VALUES (10001, 14, 'otp', 'OTP', 'grant_types', 'otp login grant', 6, 'admin', ' ', '2026-04-15 00:00:00', NULL, NULL, '0');
INSERT INTO `sys_dict_item` VALUES (10002, 14, 'passkey', 'PASSKEY', 'grant_types', 'passkey login grant', 7, 'admin', ' ', '2026-04-15 00:00:00', NULL, NULL, '0');
...
INSERT INTO `sys_menu` VALUES (4001, '文档扩展', 'doc', NULL, 'http://lumen-gateway:9999/swagger-ui.html', 4000, 'iconfont icon-biaodan', '1', 2, '0', '1', '0', '', '2018-06-26 10:50:32', 'admin', '2023-02-23 20:01:29', '0');
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_oauth_client_details` VALUES (1, 'app', NULL, 'app', 'server', 'password,refresh_token,authorization_code,client_credentials,otp,passkey', 'http://localhost:4040/sso1/login,http://localhost:4041/sso1/login,http://localhost:8080/renren-admin/sys/oauth2-sso,http://localhost:8090/sys/oauth2-sso', NULL, 43200, 2592001, '{"enc_flag":"1","captcha_flag":"1","online_quantity":"1","display_name":"会员入口","audience":"会员","description":"会员登录入口，支持密码、OTP 和 Passkey。"}', 'true', '0', '', 'admin', NULL, '2023-02-09 13:54:54');
INSERT INTO `sys_oauth_client_details` VALUES (2, 'daemon', NULL, 'daemon', 'server', 'password,refresh_token', NULL, NULL, 43200, 2592001, '{"enc_flag":"1","captcha_flag":"1","display_name":"社区运营","audience":"社区运营","description":"社区运营入口，默认使用密码登录。"}', 'true', '0', ' ', ' ', NULL, NULL);
...
INSERT INTO `sys_oauth_client_details` VALUES (5, 'lumen', NULL, 'lumen', 'server', 'password,refresh_token,authorization_code,client_credentials,otp,passkey', 'http://localhost:4040/sso1/login,http://localhost:4041/sso1/login,http://localhost:8080/renren-admin/sys/oauth2-sso,http://localhost:8090/sys/oauth2-sso', NULL, 43200, 2592001, '{"enc_flag":"1","captcha_flag":"1","online_quantity":"1","display_name":"平台运营","audience":"平台运营","description":"平台运营入口，负责 Client、登录方式和账号治理。"}', 'false', '0', '', 'admin', NULL, '2023-03-08 11:32:41');
INSERT INTO `sys_oauth_client_details` VALUES (6, 'test', NULL, 'test', 'server', 'password,refresh_token,otp,passkey', NULL, NULL, 43200, 2592001, '{"enc_flag":"0","captcha_flag":"0","display_name":"调试沙盒","audience":"调试","description":"联调专用入口，用于快速验证 Token、会话和 Passkey。"}', 'true', '0', ' ', ' ', NULL, NULL);
COMMIT;
...
-- ----------------------------
-- Table structure for auth_account_credential
-- ----------------------------
DROP TABLE IF EXISTS `auth_account_credential`;
CREATE TABLE `auth_account_credential` (
...
-- ----------------------------
-- Records of auth_account_credential
-- ----------------------------
BEGIN;
INSERT INTO `auth_account_credential` VALUES (110001, 100001, 'PASSWORD', '', '$2a$10$c/Ae0pRjJtMZg3BnvVpO.eIK6WYWVbKTzqgdy3afR7w.vd.xi3Mgy', '0', '2026-04-15 00:00:00', 'admin', '2026-04-15 00:00:00', 'admin', '2026-04-15 00:00:00');
INSERT INTO `auth_account_credential` VALUES (110002, 100001, 'OTP', '', '17034642999', '0', NULL, 'admin', '2026-04-15 00:00:00', 'admin', '2026-04-15 00:00:00');
INSERT INTO `auth_account_credential` VALUES (110003, 100002, 'PASSWORD', '', '$2a$10$c/Ae0pRjJtMZg3BnvVpO.eIK6WYWVbKTzqgdy3afR7w.vd.xi3Mgy', '0', '2026-04-15 00:00:00', 'admin', '2026-04-15 00:00:00', 'admin', '2026-04-15 00:00:00');
INSERT INTO `auth_account_credential` VALUES (110004, 100002, 'OTP', '', '17034642999', '0', NULL, 'admin', '2026-04-15 00:00:00', 'admin', '2026-04-15 00:00:00');
INSERT INTO `auth_account_credential` VALUES (110005, 100003, 'PASSWORD', '', '$2a$10$c/Ae0pRjJtMZg3BnvVpO.eIK6WYWVbKTzqgdy3afR7w.vd.xi3Mgy', '0', '2026-04-15 00:00:00', 'admin', '2026-04-15 00:00:00', 'admin', '2026-04-15 00:00:00');
INSERT INTO `auth_account_credential` VALUES (110006, 100003, 'OTP', '', '17034642999', '0', NULL, 'admin', '2026-04-15 00:00:00', 'admin', '2026-04-15 00:00:00');
INSERT INTO `auth_account_credential` VALUES (110007, 100004, 'PASSWORD', '', '$2a$10$c/Ae0pRjJtMZg3BnvVpO.eIK6WYWVbKTzqgdy3afR7w.vd.xi3Mgy', '0', '2026-04-15 00:00:00', 'admin', '2026-04-15 00:00:00', 'admin', '2026-04-15 00:00:00');
INSERT INTO `auth_account_credential` VALUES (110008, 100004, 'OTP', '', '17034642999', '0', NULL, 'admin', '2026-04-15 00:00:00', 'admin', '2026-04-15 00:00:00');
INSERT INTO `auth_account_credential` VALUES (110009, 100005, 'PASSWORD', '', '$2a$10$c/Ae0pRjJtMZg3BnvVpO.eIK6WYWVbKTzqgdy3afR7w.vd.xi3Mgy', '0', '2026-04-15 00:00:00', 'admin', '2026-04-15 00:00:00', 'admin', '2026-04-15 00:00:00');
INSERT INTO `auth_account_credential` VALUES (110010, 100005, 'OTP', '', '17034642999', '0', NULL, 'admin', '2026-04-15 00:00:00', 'admin', '2026-04-15 00:00:00');
INSERT INTO `auth_account_credential` VALUES (110011, 100006, 'PASSWORD', '', '$2a$10$c/Ae0pRjJtMZg3BnvVpO.eIK6WYWVbKTzqgdy3afR7w.vd.xi3Mgy', '0', '2026-04-15 00:00:00', 'admin', '2026-04-15 00:00:00', 'admin', '2026-04-15 00:00:00');
INSERT INTO `auth_account_credential` VALUES (110012, 100006, 'OTP', '', '17034642999', '0', NULL, 'admin', '2026-04-15 00:00:00', 'admin', '2026-04-15 00:00:00');
COMMIT;
