 ...
 */
package com.lumencloud.lumen.common.core.jackson;
...
public class LumenJavaTimeModule extends SimpleModule {

	@Serial
	private static final long serialVersionUID = 1L;

	/**
	 * LumenJavaTimeModule构造函数，用于初始化时间序列化和反序列化规则
	 */
	public LumenJavaTimeModule() {
