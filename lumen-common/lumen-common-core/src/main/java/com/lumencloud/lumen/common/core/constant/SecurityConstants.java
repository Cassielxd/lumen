...
package com.lumencloud.lumen.common.core.constant;
...
public interface SecurityConstants {
	 ...
	 * 前缀
	 */
	String PROJECT_PREFIX = "lumen";

	/**
	 * 项目的license
	 */
	String PROJECT_LICENSE = "https://lumencloud.com";
	 ...
	 * 账号客户端ID
	 */
	String DETAILS_ACCOUNT_CLIENT_ID = "account_client_id";
