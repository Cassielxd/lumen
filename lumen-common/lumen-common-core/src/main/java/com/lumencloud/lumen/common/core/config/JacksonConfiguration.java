...
package com.lumencloud.lumen.common.core.config;

import com.lumencloud.lumen.common.core.jackson.LongToStringModule;
import com.lumencloud.lumen.common.core.jackson.LumenJavaTimeModule;
...
public class JacksonConfiguration {
	...
	public JsonMapperBuilderCustomizer customizer() {
		return builder -> builder.defaultLocale(Locale.CHINA)
			...
			.addModule(new LumenJavaTimeModule())
