...
package com.lumencloud.lumen.common.log;

import com.lumencloud.lumen.admin.api.feign.RemoteLogService;
import com.lumencloud.lumen.common.log.aspect.SysLogAspect;
import com.lumencloud.lumen.common.log.config.LumenLogProperties;
import com.lumencloud.lumen.common.log.event.SysLogListener;
...
@EnableConfigurationProperties(LumenLogProperties.class)
...
public class LogAutoConfiguration {
	 ...
	 */
	@Bean
	public SysLogListener sysLogListener(LumenLogProperties logProperties, RemoteLogService remoteLogService) {
