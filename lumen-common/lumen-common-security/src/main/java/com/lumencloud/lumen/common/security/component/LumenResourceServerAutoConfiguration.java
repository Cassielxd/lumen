...
public class LumenResourceServerAutoConfiguration {
	 ...
	 */
	@Bean
	public LumenBearerTokenExtractor lumenBearerTokenExtractor(PermitAllUrlProperties urlProperties) {
		return new LumenBearerTokenExtractor(urlProperties);
	}
	...
	public OpaqueTokenIntrospector opaqueTokenIntrospector(OAuth2AuthorizationService authorizationService) {
		return new LumenCustomOpaqueTokenIntrospector(authorizationService);
	}
