package com.lumencloud.lumen.common.feign.core;
...
/**
 * LumenFeign 内部请求拦截器，用于处理 Feign 请求的 Token 校验
 *
 * @author lengleng
 * @date 2025/05/31
 */
public class LumenFeignInnerRequestInterceptor implements RequestInterceptor, Ordered {
