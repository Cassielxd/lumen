...
public class OAuth2ResourceOwnerPasswordAuthenticationConverter
	 ...
	 */
	@Override
	public OAuth2ResourceOwnerPasswordAuthenticationToken buildToken(String grantType, Authentication clientPrincipal,
			Set requestedScopes, Map additionalParameters) {
		return new OAuth2ResourceOwnerPasswordAuthenticationToken(new AuthorizationGrantType(grantType),
