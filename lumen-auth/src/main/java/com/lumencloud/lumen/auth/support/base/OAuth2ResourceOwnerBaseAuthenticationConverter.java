...
public abstract class OAuth2ResourceOwnerBaseAuthenticationConverter<T extends OAuth2ResourceOwnerBaseAuthenticationToken>
	 ...
	 * @return 构建完成的token对象
	 */
	public abstract T buildToken(String grantType, Authentication clientPrincipal, Set<String> requestedScopes,
	...
	public Authentication convert(HttpServletRequest request) {
		...
		// 创建token
		return buildToken(grantType, clientPrincipal, requestedScopes, additionalParameters);
