...
public class OAuth2ResourceOwnerSmsAuthenticationProvider
	...
	public void checkClient(RegisteredClient registeredClient) {
		...
		boolean supportsOtp = registeredClient.getAuthorizationGrantTypes()
			.contains(new AuthorizationGrantType(SecurityConstants.OTP));
		boolean supportsLegacyMobile = registeredClient.getAuthorizationGrantTypes()
			.contains(new AuthorizationGrantType(SecurityConstants.MOBILE));
		if (!supportsOtp && !supportsLegacyMobile) {
