...
import static com.lumencloud.lumen.common.core.constant.SecurityConstants.PASSWORD;
 ...
 * @date 2025/05/30
 */
public class LumenDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
	...
	public LumenDaoAuthenticationProvider() {
	...
	protected final UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication) {
		...
		Map<String, LumenUserDetailsService> userDetailsServiceMap = SpringUtil
			.getBeansOfType(LumenUserDetailsService.class);
