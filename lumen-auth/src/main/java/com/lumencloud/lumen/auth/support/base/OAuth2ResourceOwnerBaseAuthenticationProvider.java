package com.lumencloud.lumen.auth.support.base;

import cn.hutool.extra.spring.SpringUtil;
import com.lumencloud.lumen.common.security.util.OAuth2ErrorCodesExpand;
import com.lumencloud.lumen.common.security.util.ScopeException;
...
public abstract class OAuth2ResourceOwnerBaseAuthenticationProvider<T extends OAuth2ResourceOwnerBaseAuthenticationToken>
	...
	protected Authentication afterPrimaryAuthentication(T resourceOwnerAuthentication, RegisteredClient registeredClient,
			Map<String, Object> reqParameters, Authentication usernamePasswordAuthentication) {
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		try {
			...
			usernamePasswordAuthentication = afterPrimaryAuthentication(resouceOwnerBaseAuthentication, registeredClient,
					reqParameters, usernamePasswordAuthentication);
			...
			LOGGER.error("problem in authenticate", ex);
			OAuth2Error error = new OAuth2Error(OAuth2ErrorCodes.SERVER_ERROR, ex.getMessage(), ERROR_URI);
