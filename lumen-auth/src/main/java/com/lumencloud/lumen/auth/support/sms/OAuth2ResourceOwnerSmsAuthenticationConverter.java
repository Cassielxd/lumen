...
public class OAuth2ResourceOwnerSmsAuthenticationConverter
	...
	@Override
	public OAuth2ResourceOwnerSmsAuthenticationToken buildToken(String grantType, Authentication clientPrincipal,
			Set requestedScopes, Map additionalParameters) {
		String resolvedGrantType = SecurityConstants.MOBILE.equals(grantType) ? SecurityConstants.OTP : grantType;
		return new OAuth2ResourceOwnerSmsAuthenticationToken(new AuthorizationGrantType(resolvedGrantType),
